    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-md space-y-8 rounded-2xl bg-white p-8 shadow-xl ring-1 ring-slate-200">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-3xl font-bold tracking-tight text-slate-900">Student & Teacher Registration</h2>
          <p className="mt-2 text-sm text-slate-500">Register to access your dashboard. Teachers can be promoted by admins later.</p>
        </div>
